...
if __name__ == "__main__":
    ...
    param_dists = {
        ...
        'w2v__vector_size': lambda: np.random.randint(1000, 10_000),             # Dimensionality of the word vectors 
        ...
        'w2v__workers': lambda: np.random.randint(14, 15),                       # The number of worker threads to train the model
