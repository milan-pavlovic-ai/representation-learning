...
class T5Dataset(DataManager):
    ...
    def __init__(self, sample_size: float = None, preprocess: bool = True) -> None:
        ...
        super(T5Dataset, self).__init__(sample_size=sample_size, processor=processor)
        return
...
if __name__ == "__main__":
    ...
    param_dists = {
        ...
        't5__sequence_len': lambda: np.random.randint(128, 512),                   # Number of tokens in sentence (document)
