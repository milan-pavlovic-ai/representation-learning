...
class LSTMDataset(DataManager):
    ...
    def __init__(self, sample_size: float = None, preprocess: bool = True) -> None:
        ...
        super(LSTMDataset, self).__init__(sample_size=sample_size, processor=processor)
        return
...
if __name__ == "__main__":
    ...
    param_dists = {
        # Word vectorizer 
        'vec__sequence_len': lambda: np.random.randint(64, 129),                    # Sequence length during the initial vectorization of words
